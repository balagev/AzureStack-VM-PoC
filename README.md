...
Once the following code run, you will be prompted for Azure AD Tenant, Azure AD GA Credentials and VM Credentails (Azure AD user with Global Admin role, but without MFA).
